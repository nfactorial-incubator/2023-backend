...
def update_shanyrak(
    ...
    update_result = svc.repository.update_shanyrak_by_id(shanyrak_id=shanyrak_id, user_id=jwt_data.user_id, data=input.dict())
...
def update_shanyrak_photos(
    ...
    update_result = svc.repository.update_shanyrak_by_id(shanyrak_id=shanyrak_id, user_id=jwt_data.user_id, data={"media": []})
